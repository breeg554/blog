---
title: 'Contentlayer and Next.js - how easy and powerful is it?'
publishedAt: '2023/06/09'
description: 'When it comes to handling and displaying MDX files, we have a lot of options. Some time ago, I decided to try out Contentlayer and I can honestly say, I have no regrets!'
image: '/posts/contentlayer-and-nextjs/background.webp'
readIn: '7 min read'
---
...
As you can see, MDX files are processed by [Contentlayer](https://www.contentlayer.dev/). After reviewing the documentation, I decided to try it out on my own blog. Now, I can truly say that it was a great choice.

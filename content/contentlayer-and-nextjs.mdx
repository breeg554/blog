...
description: 'Harnessing the power of Next.js with Contentlayer: a smooth, fast and typesafe setup that significantly accelerates the creation and handling of MDX files.'
